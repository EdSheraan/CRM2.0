...
<html>
    ...
    <body class="white">
        ...
        <div class="fixed-action-btn" style="bottom: 10%; right: 19px;" >
            <a class="btn-floating btn-large green accent-4 btn tooltipped" onclick="createDistrito()" data-tooltip="Añadir"  >
        ...
        <script src="<c:url value="/resources/js/service/jsDistritoService.js"></c:url>" type="text/javascript"></script>
        <script src="<c:url value="/resources/js/vista/jsDistrito.js"></c:url>" type="text/javascript"></script>
